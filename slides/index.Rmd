...
- O trabalho final de vocês será criar um também!
  ...
  - Defina um público alvo (a comunicação depende de quem vai consumir a análise).
...
.pull-left[
- As versões mais recentes do RStudio permitem usar o Visual Markdown Editor.
